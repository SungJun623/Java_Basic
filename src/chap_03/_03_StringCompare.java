...
public class _03_StringCompare {
    public static void main(String[] args) {
        ...
        System.out.println(s2.equals("python")); // 대소문자가 다르기때문에 false
        ...
        s1 = new String("1234"); // new를 붙이면 메모리하는 저장공간이 다르다
        s2 = new String("1234"); // 따라서 new를 붙였기때문에 서론 다른 각각의 공간에 메모리한것
