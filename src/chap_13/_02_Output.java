...
public class _02_Output {
    public static void main(String[] args) {
        ...
        System.out.printf("%06d%n", 1234); // 001234 (6자리의 공간을 확보 후 1234 출력하는데 빈 공간은 0 으로 채움)
        ...
        System.out.printf("%+6.2f%n", Math.PI); // _+3.14 (항상 +- 기호표시)
        ...
        System.out.println("최치수 " + 95 + " " + 100 + " " + 97.5); // 최치수 95 100 97.5
